push @output, "vs.1.1																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(1)\n";
...
push @output, "; Transform the position from world to view space																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(5)\n";
push @output, "dp4 oPos.x, $vPos, $cModelViewProj0																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(6)\n";
push @output, "dp4 oPos.y, $vPos, $cModelViewProj1																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(7)\n";
push @output, "dp4 oPos.z, $vPos, $cModelViewProj2																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(8)\n";
push @output, "dp4 oPos.w, $vPos, $cModelViewProj3																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(9)\n";
push @output, "mov oD0, $cOne																								; LINEINFO(UnlitGeneric_LightingOnlyWorld.vsh)(11)\n";
