push @output, "vs.1.1																								; LINEINFO(BumpmappedLightmap.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(BumpmappedLightmap.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(7)\n";
local( $projPos ); &AllocateRegister( \$projPos, "\$projPos" );
push @output, "; Transform position from object to projection space																								; LINEINFO(BumpmappedLightmap.vsh)(11)\n";
push @output, "; put in r1 now since we need it for fog.																								; LINEINFO(BumpmappedLightmap.vsh)(12)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(BumpmappedLightmap.vsh)(13)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(BumpmappedLightmap.vsh)(14)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(BumpmappedLightmap.vsh)(15)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(BumpmappedLightmap.vsh)(16)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(BumpmappedLightmap.vsh)(18)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(BumpmappedLightmap.vsh)(23)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(BumpmappedLightmap.vsh)(24)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(30)\n";
push @output, "; Texture coordinates																								; LINEINFO(BumpmappedLightmap.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(32)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(BumpmappedLightmap.vsh)(34)\n";
push @output, "; each bumped lightmap																								; LINEINFO(BumpmappedLightmap.vsh)(35)\n";
&AllocateRegister( \$bumpOffset, "\$bumpOffset" );																								
push @output, "mov $bumpOffset.xy, $vTexCoord2																								; LINEINFO(BumpmappedLightmap.vsh)(39)\n";
push @output, "mov oT0, $vTexCoord0				; bumpmap texcoords 																								; LINEINFO(BumpmappedLightmap.vsh)(40)\n";
push @output, "add oT1.xy, $bumpOffset, $vTexCoord1			; first lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(41)\n";
push @output, "mad oT2.xy, $bumpOffset, $cTwo, $vTexCoord1		; second lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(42)\n";
push @output, "mad oT3.xy, $bumpOffset, $cThree, $vTexCoord1	; third lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(43)\n";
&FreeRegister( \$bumpOffset, "\$bumpOffset" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(47)\n";
push @output, "; Fog																								; LINEINFO(BumpmappedLightmap.vsh)(48)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(49)\n";
