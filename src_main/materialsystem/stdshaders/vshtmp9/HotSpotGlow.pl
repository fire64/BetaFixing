push @output, "vs.1.1																								; LINEINFO(HotSpotGlow.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(4)\n";
push @output, "; Vertex blending																								; LINEINFO(HotSpotGlow.vsh)(5)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(6)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(HotSpotGlow.vsh)(10)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(HotSpotGlow.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(HotSpotGlow.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(HotSpotGlow.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(HotSpotGlow.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(HotSpotGlow.vsh)(16)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(18)\n";
push @output, "; Fog																								; LINEINFO(HotSpotGlow.vsh)(19)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(20)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(HotSpotGlow.vsh)(25)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(HotSpotGlow.vsh)(26)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(33)\n";
push @output, "; Texture coordinates																								; LINEINFO(HotSpotGlow.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(HotSpotGlow.vsh)(35)\n";
push @output, "; Just copy the texture coordinates	with an offset																								; LINEINFO(HotSpotGlow.vsh)(37)\n";
push @output, ";add oT0, $vTexCoord0, c90																								; LINEINFO(HotSpotGlow.vsh)(38)\n";
push @output, "add oT0, $vTexCoord0, c95.yyzz	; FIXME																								; LINEINFO(HotSpotGlow.vsh)(39)\n";
push @output, "add oT1, $vTexCoord0, c95.xyzz	; FIXME																								; LINEINFO(HotSpotGlow.vsh)(40)\n";
push @output, "add oT2, $vTexCoord0, c95.xxzz	; FIXME																								; LINEINFO(HotSpotGlow.vsh)(41)\n";
push @output, "add oT3, $vTexCoord0, c95.yxzz	; FIXME																								; LINEINFO(HotSpotGlow.vsh)(42)\n";
