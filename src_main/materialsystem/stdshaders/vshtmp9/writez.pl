push @output, "vs.1.1																								; LINEINFO(writez.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(writez.vsh)(5)\n";
 	 push @output, ";	 c90-c91 = Base texture transform																								; LINEINFO(writez.vsh)(6)\n";
     push @output, ";    c92-c93 = Mask texture transform																								; LINEINFO(writez.vsh)(7)\n";
 	 push @output, ";	 c94	 = Modulation color 																								; LINEINFO(writez.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(writez.vsh)(9)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(writez.vsh)(13)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(writez.vsh)(14)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(writez.vsh)(15)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(writez.vsh)(16)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(writez.vsh)(17)\n";
