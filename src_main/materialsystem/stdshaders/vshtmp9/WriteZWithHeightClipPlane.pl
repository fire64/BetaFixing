push @output, "vs.1.1																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(6)\n";
push @output, "; Vertex blending																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(8)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $g_numBones, $worldPos );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(12)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(14)\n";
push @output, "dp4 oPos.x, $worldPos, $cViewProj0																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(16)\n";
push @output, "dp4 oPos.y, $worldPos, $cViewProj1																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(17)\n";
push @output, "dp4 oPos.z, $worldPos, $cViewProj2																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(18)\n";
push @output, "dp4 oPos.w, $worldPos, $cViewProj3																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(19)\n";
&AllocateRegister( \$tmp, "\$tmp" );																								
&DoHeightClip( $worldPos, "oT0" );																								
push @output, "mov oD0, $cOne																								; LINEINFO(WriteZWithHeightClipPlane.vsh)(24)\n";
