push @output, "vs.1.1																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(1)\n";
...
push @output, "; Transform the position from world to view space																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(8)\n";
push @output, "dp4 oPos.x, $worldPos, $cViewProj0																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(9)\n";
push @output, "dp4 oPos.y, $worldPos, $cViewProj1																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(10)\n";
push @output, "dp4 oPos.z, $worldPos, $cViewProj2																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(11)\n";
push @output, "dp4 oPos.w, $worldPos, $cViewProj3																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(12)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "mov oD0, $cOne																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(16)\n";
