push @output, "vs.1.1																								; LINEINFO(WorldVertexTransition_Micros.vsh)(1)\n";
...
push @output, "dp4 $projPos.x, $vPos, $cViewProj0																								; LINEINFO(WorldVertexTransition_Micros.vsh)(8)\n";
push @output, "dp4 $projPos.y, $vPos, $cViewProj1																								; LINEINFO(WorldVertexTransition_Micros.vsh)(9)\n";
push @output, "dp4 $projPos.z, $vPos, $cViewProj2																								; LINEINFO(WorldVertexTransition_Micros.vsh)(10)\n";
push @output, "dp4 $projPos.w, $vPos, $cViewProj3																								; LINEINFO(WorldVertexTransition_Micros.vsh)(11)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexTransition_Micros.vsh)(12)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexTransition_Micros.vsh)(15)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );
&FreeRegister( \$worldPos, "\$worldPos" );
push @output, "mov oD0, $vColor																								; LINEINFO(WorldVertexTransition_Micros.vsh)(22)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(WorldVertexTransition_Micros.vsh)(24)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(WorldVertexTransition_Micros.vsh)(25)\n";
push @output, "dp4 oT1.x, $vTexCoord0, c92																								; LINEINFO(WorldVertexTransition_Micros.vsh)(27)\n";
push @output, "dp4 oT1.y, $vTexCoord0, c93																								; LINEINFO(WorldVertexTransition_Micros.vsh)(28)\n";
push @output, "mov oT2, $vTexCoord1																								; LINEINFO(WorldVertexTransition_Micros.vsh)(30)\n";
push @output, "dp4 oT3.x, $vTexCoord0, c94																								; LINEINFO(WorldVertexTransition_Micros.vsh)(32)\n";
push @output, "dp4 oT3.y, $vTexCoord0, c95																								; LINEINFO(WorldVertexTransition_Micros.vsh)(33)\n";
