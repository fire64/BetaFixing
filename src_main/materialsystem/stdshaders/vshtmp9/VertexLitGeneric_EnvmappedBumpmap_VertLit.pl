push @output, "vs.1.1																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(3)\n";
push @output, "; Shader specific constant:																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(4)\n";
 	 push @output, ";	 c95	 = [sOffset, tOffset, 0, 0]																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(5)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(6)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(10)\n";
push @output, "; Vertex blending																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(11)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(12)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(22)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(23)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(24)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(28)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(29)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(30)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(31)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(32)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(34)\n";
push @output, "; Fog																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(36)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(41)\n";
push @output, "; Lighting 																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(42)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(43)\n";
&DoLighting( $g_staticLightType, $g_ambientLightType, $g_localLightType1, 																								
			 $g_localLightType2, $worldPos, $worldNormal );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(47)\n";
push @output, "; Lighting																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(48)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(49)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(51)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(52)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(53)\n";
push @output, "; to environment map space. 																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(54)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(55)\n";
push @output, "; svect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(57)\n";
push @output, "mov oT1.x, $worldTangentS.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(58)\n";
push @output, "mov oT2.x, $worldTangentS.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(59)\n";
push @output, "mov oT3.x, $worldTangentS.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(60)\n";
&FreeRegister( \$worldTangentS, "\$worldTangentS" );																								
push @output, "; tvect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(63)\n";
push @output, "mov oT1.y, $worldTangentT.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(64)\n";
push @output, "mov oT2.y, $worldTangentT.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(65)\n";
push @output, "mov oT3.y, $worldTangentT.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(66)\n";
&FreeRegister( \$worldTangentT, "\$worldTangentT" );																								
push @output, "; normal																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(69)\n";
push @output, "mov oT1.z, $worldNormal.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(70)\n";
push @output, "mov oT2.z, $worldNormal.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(71)\n";
push @output, "mov oT3.z, $worldNormal.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(72)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(76)\n";
&AllocateRegister( \$eyeVector, "\$eyeVector" );																								
push @output, "sub $eyeVector.xyz, $cEyePos, $worldPos  																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(78)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Move it into the w component of the texture coords, as the wacky																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(82)\n";
push @output, "; pixel shader wants it there.																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(83)\n";
push @output, "mov oT1.w, $eyeVector.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(84)\n";
push @output, "mov oT2.w, $eyeVector.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(85)\n";
push @output, "mov oT3.w, $eyeVector.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(86)\n";
&FreeRegister( \$eyeVector, "\$eyeVector" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(90)\n";
push @output, "; Texture coordinates																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(91)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(92)\n";
push @output, "; Just copy the texture coordinates	for the normal map																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(94)\n";
push @output, ";add oT0, $vTexCoord0, c95																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(95)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_VertLit.vsh)(96)\n";
