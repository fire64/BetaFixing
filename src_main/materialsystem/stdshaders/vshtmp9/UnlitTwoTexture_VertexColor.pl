push @output, "vs.1.1																								; LINEINFO(UnlitTwoTexture_VertexColor.vsh)(1)\n";
...
{																								
	...
	push @output, "	dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(unlittwotexture_inc.vsh)(37)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(unlittwotexture_inc.vsh)(38)\n";
	push @output, "	dp4 oT1.x, $vTexCoord0, c92																								; LINEINFO(unlittwotexture_inc.vsh)(40)\n";
	push @output, "	dp4 oT1.y, $vTexCoord0, c93																								; LINEINFO(unlittwotexture_inc.vsh)(41)\n";
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(unlittwotexture_inc.vsh)(45)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(unlittwotexture_inc.vsh)(46)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(unlittwotexture_inc.vsh)(50)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(unlittwotexture_inc.vsh)(51)\n";
	}																								
}																								
$vertexcolor = 1;																								
