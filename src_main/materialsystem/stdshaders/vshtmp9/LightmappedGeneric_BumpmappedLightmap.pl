push @output, "vs.1.1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(7)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(11)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(12)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(13)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(14)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(15)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(17)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(19)\n";
push @output, "; Fog																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(20)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(21)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(26)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(27)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(34)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(36)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(38)\n";
push @output, "; each bumped lightmap																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(39)\n";
&AllocateRegister( \$offset, "\$offset" );																								
push @output, "mov $offset.xy, $vTexCoord2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(41)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(42)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(43)\n";
push @output, "add oT1.xy, $offset, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(44)\n";
push @output, "mad oT2.xy, $offset, $cTwo, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(45)\n";
push @output, "mad oT3.xy, $offset, $cThree, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap.vsh)(46)\n";
