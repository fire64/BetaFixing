push @output, "vs.1.1																								; LINEINFO(ShadowModel.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(3)\n";
push @output, "; Constants specified by the app																								; LINEINFO(ShadowModel.vsh)(4)\n";
 	 push @output, ";	 c20	 = Shadow color																								; LINEINFO(ShadowModel.vsh)(5)\n";
 	 push @output, ";	 c90-c92 = Shadow texture matrix																								; LINEINFO(ShadowModel.vsh)(6)\n";
 	 push @output, ";	 c93	 = Tex origin																								; LINEINFO(ShadowModel.vsh)(7)\n";
 	 push @output, ";	 c94	 = Tex Scale																								; LINEINFO(ShadowModel.vsh)(8)\n";
 	 push @output, ";	 c95	 = [Shadow falloff offset, 1/Shadow distance, Shadow scale, 0 ]																								; LINEINFO(ShadowModel.vsh)(9)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(10)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(14)\n";
push @output, "; Vertex blending (whacks r1-r7, positions in r7, normals in r8)																								; LINEINFO(ShadowModel.vsh)(15)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(16)\n";
...
push @output, "; Transform the position from world to view space																								; LINEINFO(ShadowModel.vsh)(21)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(ShadowModel.vsh)(24)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(ShadowModel.vsh)(25)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(ShadowModel.vsh)(26)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(ShadowModel.vsh)(27)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(ShadowModel.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(30)\n";
push @output, "; Fog																								; LINEINFO(ShadowModel.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(32)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(36)\n";
push @output, "; Transform position into texture space (from 0 to 1)																								; LINEINFO(ShadowModel.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(38)\n";
&AllocateRegister( \$texturePos, "\$texturePos" );																								
push @output, "dp4 $texturePos.x, $worldPos, c90																								; LINEINFO(ShadowModel.vsh)(40)\n";
push @output, "dp4 $texturePos.y, $worldPos, c91																								; LINEINFO(ShadowModel.vsh)(41)\n";
push @output, "dp4 $texturePos.z, $worldPos, c92																								; LINEINFO(ShadowModel.vsh)(42)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(45)\n";
push @output, "; Figure out the shadow fade amount																								; LINEINFO(ShadowModel.vsh)(46)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(47)\n";
&AllocateRegister( \$shadowFade, "\$shadowFade" );																								
push @output, "sub $shadowFade, $texturePos.z, c95.x																								; LINEINFO(ShadowModel.vsh)(49)\n";
push @output, "mul $shadowFade, $shadowFade, c95.y																								; LINEINFO(ShadowModel.vsh)(50)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(52)\n";
push @output, "; Offset it into the texture																								; LINEINFO(ShadowModel.vsh)(53)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(54)\n";
&AllocateRegister( \$actualTextureCoord, "\$actualTextureCoord" );																								
push @output, "mul $actualTextureCoord.xyz, c94, $texturePos																								; LINEINFO(ShadowModel.vsh)(56)\n";
push @output, "add oT0.xyz, $actualTextureCoord, c93																								; LINEINFO(ShadowModel.vsh)(57)\n";
push @output, ";mov oT0.xyz, $texturePos																								; LINEINFO(ShadowModel.vsh)(58)\n";
&FreeRegister( \$actualTextureCoord, "\$actualTextureCoord" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(61)\n";
push @output, "; We're doing clipping by using texkill																								; LINEINFO(ShadowModel.vsh)(62)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(63)\n";
push @output, "mov oT1.xyz, $texturePos		; also clips when shadow z < 0 !																								; LINEINFO(ShadowModel.vsh)(64)\n";
push @output, "sub oT2.xyz, c0.y, $texturePos																								; LINEINFO(ShadowModel.vsh)(65)\n";
push @output, "sub oT2.z, c0.y, $shadowFade.z	; clips when shadow z > shadow distance																									; LINEINFO(ShadowModel.vsh)(66)\n";
&FreeRegister( \$texturePos, "\$texturePos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(69)\n";
push @output, "; We're doing backface culling by using texkill also (wow yucky)																								; LINEINFO(ShadowModel.vsh)(70)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(71)\n";
push @output, "; Transform z component of normal in texture space																								; LINEINFO(ShadowModel.vsh)(72)\n";
push @output, "; If it's negative, then don't draw the pixel																								; LINEINFO(ShadowModel.vsh)(73)\n";
push @output, "dp3 oT3, $worldNormal, -c92																								; LINEINFO(ShadowModel.vsh)(74)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(77)\n";
push @output, "; Shadow color, falloff																								; LINEINFO(ShadowModel.vsh)(78)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(79)\n";
push @output, "mov oD0, $cModulationColor																								; LINEINFO(ShadowModel.vsh)(80)\n";
push @output, "mul oD0.w, $shadowFade.x, c95.z																								; LINEINFO(ShadowModel.vsh)(81)\n";
&FreeRegister( \$shadowFade, "\$shadowFade" );																								
