push @output, "vs.1.1																								; LINEINFO(JellyFish.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(JellyFish.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(7)\n";
$cView0 = "c90";																								
$cView1 = "c91";																								
$cView2 = "c92";																								
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(17)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(JellyFish.vsh)(18)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(19)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(JellyFish.vsh)(23)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(JellyFish.vsh)(24)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(JellyFish.vsh)(25)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(JellyFish.vsh)(26)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(JellyFish.vsh)(27)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(29)\n";
push @output, "; Fog																								; LINEINFO(JellyFish.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(31)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
&AllocateRegister( \$viewNormal, "\$viewNormal" );																								
push @output, "; Transform the normal from object to view space																								; LINEINFO(JellyFish.vsh)(39)\n";
push @output, "dp3 $viewNormal.x, $worldNormal, $cView0																								; LINEINFO(JellyFish.vsh)(40)\n";
push @output, "dp3 $viewNormal.y, $worldNormal, $cView1																								; LINEINFO(JellyFish.vsh)(41)\n";
push @output, "dp3 $viewNormal.z, $worldNormal, $cView2																								; LINEINFO(JellyFish.vsh)(42)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; normalize normal (do we need to do this?)																								; LINEINFO(JellyFish.vsh)(45)\n";
&Normalize( $viewNormal );																								
&AllocateRegister( \$viewPos, "\$viewPos" );																								
push @output, "; Transform position from object to view space																								; LINEINFO(JellyFish.vsh)(51)\n";
push @output, "dp4 $viewPos.x, $worldPos, $cView0																								; LINEINFO(JellyFish.vsh)(52)\n";
push @output, "dp4 $viewPos.y, $worldPos, $cView1																								; LINEINFO(JellyFish.vsh)(53)\n";
push @output, "dp4 $viewPos.z, $worldPos, $cView2																								; LINEINFO(JellyFish.vsh)(54)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
&AllocateRegister( \$vertToEye, "\$vertToEye" );																								
push @output, "; vector from point to eye in view space																								; LINEINFO(JellyFish.vsh)(59)\n";
push @output, "mov $vertToEye.xyz, -$viewPos																								; LINEINFO(JellyFish.vsh)(60)\n";
&FreeRegister( \$viewPos, "\$viewPos" );																								
push @output, "; normalize																								; LINEINFO(JellyFish.vsh)(64)\n";
&Normalize( $vertToEye );																								
push @output, "dp3 $viewNormal.x, $vertToEye, $viewNormal																								; LINEINFO(JellyFish.vsh)(67)\n";
push @output, "add $viewNormal.x, $viewNormal.x, c95 ; FIXME																								; LINEINFO(JellyFish.vsh)(68)\n";
&FreeRegister( \$vertToEye, "\$vertToEye" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(72)\n";
push @output, "; Texture coordinates																								; LINEINFO(JellyFish.vsh)(73)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(74)\n";
push @output, "mov oT0, $viewNormal																								; LINEINFO(JellyFish.vsh)(76)\n";
push @output, "mov oT1, $vTexCoord0																								; LINEINFO(JellyFish.vsh)(77)\n";
&FreeRegister( \$viewNormal, "\$viewNormal" );																								
