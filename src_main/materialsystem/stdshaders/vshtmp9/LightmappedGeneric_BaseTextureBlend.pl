push @output, "vs.1.1																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(7)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(15)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(20)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(21)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(28)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(29)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(30)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(32)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(33)\n";
push @output, "dp4 oT1.x, $vTexCoord0, c92																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(35)\n";
push @output, "dp4 oT1.y, $vTexCoord0, c93																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(36)\n";
push @output, "mov oT2, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BaseTextureBlend.vsh)(38)\n";
