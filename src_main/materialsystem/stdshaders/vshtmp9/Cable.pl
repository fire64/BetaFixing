push @output, "vs.1.1																								; LINEINFO(Cable.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(5)\n";
push @output, "; The cable equation is:																								; LINEINFO(Cable.vsh)(6)\n";
push @output, "; [L dot N] * C * T																								; LINEINFO(Cable.vsh)(7)\n";
 																								push @output, ";																								; LINEINFO(Cable.vsh)(8)\n";
push @output, "; where:																								; LINEINFO(Cable.vsh)(9)\n";
push @output, "; C = directional light color																								; LINEINFO(Cable.vsh)(10)\n";
push @output, "; T = baseTexture																								; LINEINFO(Cable.vsh)(11)\n";
push @output, "; N = particle normal (stored in the normal map)																								; LINEINFO(Cable.vsh)(12)\n";
push @output, "; L = directional light direction																								; LINEINFO(Cable.vsh)(13)\n";
 																								push @output, ";																								; LINEINFO(Cable.vsh)(14)\n";
 	push @output, ";	c90		= Directional light direction // FIXME																								; LINEINFO(Cable.vsh)(15)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(16)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(19)\n";
push @output, "; Transform position from object to projection space																								; LINEINFO(Cable.vsh)(20)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(21)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4		$projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(Cable.vsh)(25)\n";
push @output, "dp4		$projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(Cable.vsh)(26)\n";
push @output, "dp4		$projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(Cable.vsh)(27)\n";
push @output, "dp4		$projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(Cable.vsh)(28)\n";
push @output, "mov		oPos, $projPos																								; LINEINFO(Cable.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(33)\n";
push @output, "; Fog																								; LINEINFO(Cable.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(35)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(Cable.vsh)(40)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(Cable.vsh)(41)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(48)\n";
push @output, "; Setup the tangent space																								; LINEINFO(Cable.vsh)(49)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(50)\n";
&AllocateRegister( \$tmp1, "\$tmp1" );																								
&AllocateRegister( \$tmp2, "\$tmp2" );																								
&AllocateRegister( \$tmp3, "\$tmp3" );																								
&AllocateRegister( \$r, "\$r" );																								
push @output, "; Get S crossed with T (call it R)																								; LINEINFO(Cable.vsh)(57)\n";
push @output, "mov		$tmp1, $vTangentS																								; LINEINFO(Cable.vsh)(58)\n";
push @output, "mov		$tmp2, $vTangentT																								; LINEINFO(Cable.vsh)(59)\n";
push @output, "mul		$tmp3, $vTangentS.yzxw,  $tmp2.zxyw																								; LINEINFO(Cable.vsh)(61)\n";
push @output, "mad		$r, -$vTangentS.zxyw, $tmp2.yzxw, $tmp3																								; LINEINFO(Cable.vsh)(62)\n";
&FreeRegister( \$tmp2, "\$tmp2" );																								
&FreeRegister( \$tmp3, "\$tmp3" );																								
&AllocateRegister( \$s, "\$s" );																								
push @output, "; Normalize S (into $s)																								; LINEINFO(Cable.vsh)(69)\n";
push @output, "dp3		$s.w, $vTangentS, $vTangentS																								; LINEINFO(Cable.vsh)(70)\n";
push @output, "rsq		$s.w, $s.w																								; LINEINFO(Cable.vsh)(71)\n";
push @output, "mul		$s.xyz, $vTangentS, $s.w																								; LINEINFO(Cable.vsh)(72)\n";
push @output, "; Normalize R (into $r)																								; LINEINFO(Cable.vsh)(74)\n";
push @output, "dp3		$r.w, $r, $r																								; LINEINFO(Cable.vsh)(75)\n";
push @output, "rsq		$r.w, $r.w																								; LINEINFO(Cable.vsh)(76)\n";
push @output, "mul		$r.xyz, $r, $r.w																								; LINEINFO(Cable.vsh)(77)\n";
&AllocateRegister( \$t, "\$t" );																								
push @output, "; Regenerate T (into $t)																								; LINEINFO(Cable.vsh)(81)\n";
push @output, "mul		$t, $r.yzxw,  $tmp1.zxyw																								; LINEINFO(Cable.vsh)(82)\n";
push @output, "mad		$t, -$r.zxyw, $tmp1.yzxw, $t																								; LINEINFO(Cable.vsh)(83)\n";
&FreeRegister( \$tmp1, "\$tmp1" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(87)\n";
push @output, "; Transform the light direction (into oD1)																								; LINEINFO(Cable.vsh)(88)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(89)\n";
&AllocateRegister( \$lightDirection, "\$lightDirection" );																								
push @output, "dp3		$lightDirection.x, $s, c90 ; FIXME																								; LINEINFO(Cable.vsh)(93)\n";
push @output, "dp3		$lightDirection.y, $t, c90 ; FIXME																								; LINEINFO(Cable.vsh)(94)\n";
push @output, "dp3		$lightDirection.z, $r, c90 ; FIXME																								; LINEINFO(Cable.vsh)(95)\n";
&FreeRegister( \$r, "\$r" );																								
&FreeRegister( \$s, "\$s" );																								
&FreeRegister( \$t, "\$t" );																								
push @output, "; Scale into 0-1 range (we're assuming light direction was normalized prior to here)																								; LINEINFO(Cable.vsh)(101)\n";
push @output, "add		oD1, $lightDirection, $cHalf	; + 0.5 																								; LINEINFO(Cable.vsh)(102)\n";
&FreeRegister( \$lightDirection, "\$lightDirection" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(105)\n";
push @output, "; Copy texcoords for the normal map and base texture																								; LINEINFO(Cable.vsh)(106)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Cable.vsh)(107)\n";
push @output, "mov		oT0, $vTexCoord0																								; LINEINFO(Cable.vsh)(109)\n";
push @output, "mov		oT1, $vTexCoord1																								; LINEINFO(Cable.vsh)(110)\n";
push @output, "; Pass the dirlight color through																								; LINEINFO(Cable.vsh)(112)\n";
push @output, "mov		oD0.xyzw, $vColor																								; LINEINFO(Cable.vsh)(113)\n";
