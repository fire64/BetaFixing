push @output, "vs.1.1																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(7)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $g_numBones, $worldPos );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(11)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(12)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(13)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(17)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(18)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(19)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(20)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(23)\n";
push @output, "; Fog																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(24)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(25)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(31)\n";
push @output, "; Texture coordinates																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(32)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(33)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90  ; FIXME																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(35)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91  ; FIXME																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(36)\n";
