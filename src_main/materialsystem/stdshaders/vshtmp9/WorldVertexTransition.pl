push @output, "vs.1.1																								; LINEINFO(WorldVertexTransition.vsh)(1)\n";
...
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WorldVertexTransition.vsh)(9)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WorldVertexTransition.vsh)(10)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WorldVertexTransition.vsh)(11)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WorldVertexTransition.vsh)(12)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexTransition.vsh)(13)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; garymcthack																								; LINEINFO(WorldVertexTransition.vsh)(17)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexTransition.vsh)(18)\n";
&CalcFog( $worldPos, $projPos );																								
&DoHeightClip( $worldPos, "oT3" );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition.vsh)(26)\n";
push @output, "; Texture coordinates																								; LINEINFO(WorldVertexTransition.vsh)(27)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition.vsh)(28)\n";
push @output, "; base texcoords																								; LINEINFO(WorldVertexTransition.vsh)(29)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(WorldVertexTransition.vsh)(30)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(WorldVertexTransition.vsh)(31)\n";
push @output, "dp4 oT1.x, $vTexCoord0, c92																								; LINEINFO(WorldVertexTransition.vsh)(33)\n";
push @output, "dp4 oT1.y, $vTexCoord0, c93																								; LINEINFO(WorldVertexTransition.vsh)(34)\n";
push @output, "; lightmap texcoords																								; LINEINFO(WorldVertexTransition.vsh)(37)\n";
push @output, "mov oT2, $vTexCoord1																								; LINEINFO(WorldVertexTransition.vsh)(38)\n";
