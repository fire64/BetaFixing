push @output, "vs.1.1																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(6)\n";
push @output, "; Vertex blending																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(8)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(11)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(12)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(13)\n";
push @output, "dp4 oPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(15)\n";
push @output, "dp4 oPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(16)\n";
push @output, "dp4 oPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(17)\n";
push @output, "dp4 oPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(18)\n";
push @output, "; Transform the position to world space																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(20)\n";
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(21)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(22)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(23)\n";
&DoHeightClip( $worldPos, "oT0" );																								
push @output, "mov oD0, $cOne																								; LINEINFO(WriteZWithHeightClipPlane_World.vsh)(27)\n";
