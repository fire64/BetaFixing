push @output, "vs.1.1																								; LINEINFO(LightmappedTranslucentTexture.vsh)(1)\n";
push @output, "; FIXME - this is the same as LightmappedGeneric.vsh!!!																								; LINEINFO(LightmappedTranslucentTexture.vsh)(3)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_inc.vsh)(3)\n";
 	 push @output, ";	 c90-c91 = Base texture transform																								; LINEINFO(LightmappedGeneric_inc.vsh)(4)\n";
     push @output, ";    c92-c93 = Mask texture transform																								; LINEINFO(LightmappedGeneric_inc.vsh)(5)\n";
 	 push @output, ";	 c94	 = Modulation color 																								; LINEINFO(LightmappedGeneric_inc.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_inc.vsh)(7)\n";
...
{																								
	...
	push @output, "	dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_inc.vsh)(21)\n";
	push @output, "	dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_inc.vsh)(22)\n";
	push @output, "	dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_inc.vsh)(23)\n";
	push @output, "	dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_inc.vsh)(24)\n";
	push @output, "	mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_inc.vsh)(25)\n";
	&AllocateRegister( \$worldPos, "\$worldPos" );																								
	if( $g_fogType eq "heightfog" )																								
	{																								
		push @output, "		; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_inc.vsh)(31)\n";
		push @output, "		dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_inc.vsh)(32)\n";
	}																								
	&CalcFog( $worldPos, $projPos );																								
	&FreeRegister( \$projPos, "\$projPos" );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_inc.vsh)(37)\n";
	push @output, "	; Texture coordinates																								; LINEINFO(LightmappedGeneric_inc.vsh)(38)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_inc.vsh)(39)\n";
	push @output, "	; base texcoords																								; LINEINFO(LightmappedGeneric_inc.vsh)(40)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, c90 ; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(41)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, c91 ; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(42)\n";
	push @output, "	; lightmap texcoords																								; LINEINFO(LightmappedGeneric_inc.vsh)(44)\n";
	push @output, "	mov oT1, $vTexCoord1																								; LINEINFO(LightmappedGeneric_inc.vsh)(45)\n";
	if( $envmap )																								
	{																								
		&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
		push @output, "		; Transform the position + normal to world space																								; LINEINFO(LightmappedGeneric_inc.vsh)(51)\n";
		push @output, "		dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(LightmappedGeneric_inc.vsh)(52)\n";
		push @output, "		dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(LightmappedGeneric_inc.vsh)(53)\n";
		if( $g_fogType ne "heightfog" )																								
		{																								
			push @output, "			dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_inc.vsh)(56)\n";
		}																								
		push @output, "		dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(LightmappedGeneric_inc.vsh)(59)\n";
		push @output, "		dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(LightmappedGeneric_inc.vsh)(60)\n";
		push @output, "		dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(LightmappedGeneric_inc.vsh)(61)\n";
		...
		{																								
			...
			push @output, "			; transform reflection vector into view space																								; LINEINFO(LightmappedGeneric_inc.vsh)(67)\n";
			push @output, "			dp3 oT2.x, $reflectionVector, $cViewModel0																								; LINEINFO(LightmappedGeneric_inc.vsh)(68)\n";
			push @output, "			dp3 oT2.y, $reflectionVector, $cViewModel1																								; LINEINFO(LightmappedGeneric_inc.vsh)(69)\n";
			push @output, "			dp3 oT2.z, $reflectionVector, $cViewModel2																								; LINEINFO(LightmappedGeneric_inc.vsh)(70)\n";
		...
		push @output, "		; envmap mask																								; LINEINFO(LightmappedGeneric_inc.vsh)(84)\n";
		push @output, "		dp4 oT3.x, $vTexCoord0, c92	; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(85)\n";
		push @output, "		dp4 oT3.y, $vTexCoord0, c93	; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(86)\n";
#		&FreeRegister( \$worldPos, "\$worldPos" );																								
	...
	if( $detail )																								
	{																								
		push @output, "		dp4 oT2.x, $vTexCoord0, c94		; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(96)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, c95		; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(97)\n";
	}																								
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(LightmappedGeneric_inc.vsh)(102)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(LightmappedGeneric_inc.vsh)(103)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(LightmappedGeneric_inc.vsh)(107)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(LightmappedGeneric_inc.vsh)(108)\n";
	}																								
}																								
$detail = 0;																								
$envmap = 0;																								
