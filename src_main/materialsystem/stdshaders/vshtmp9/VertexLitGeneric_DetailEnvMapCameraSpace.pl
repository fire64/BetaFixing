push @output, "vs.1.1																								; LINEINFO(VertexLitGeneric_DetailEnvMapCameraSpace.vsh)(1)\n";
...
{																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(13)\n";
	push @output, "	; Vertex blending 																								; LINEINFO(VertexLitGeneric_inc.vsh)(14)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(15)\n";
	...
	{																								
		push @output, "		; Special case for static prop lighting.  We can go directly from 																								; LINEINFO(VertexLitGeneric_inc.vsh)(22)\n";
		push @output, "		; world to proj space for position, with the exception of z, which 																								; LINEINFO(VertexLitGeneric_inc.vsh)(23)\n";
		push @output, "		; is needed for fogging *if* height fog is enabled.																								; LINEINFO(VertexLitGeneric_inc.vsh)(24)\n";
		push @output, "		; NOTE: We don't use this path if $envmap is defined since we need																								; LINEINFO(VertexLitGeneric_inc.vsh)(26)\n";
		push @output, "		; worldpos for envmapping.																								; LINEINFO(VertexLitGeneric_inc.vsh)(27)\n";
		push @output, "		dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(VertexLitGeneric_inc.vsh)(28)\n";
		push @output, "		dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(VertexLitGeneric_inc.vsh)(29)\n";
		push @output, "		dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(VertexLitGeneric_inc.vsh)(30)\n";
		push @output, "		dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(VertexLitGeneric_inc.vsh)(31)\n";
		push @output, "		; normal																								; LINEINFO(VertexLitGeneric_inc.vsh)(32)\n";
		push @output, "		dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(VertexLitGeneric_inc.vsh)(33)\n";
		push @output, "		dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(VertexLitGeneric_inc.vsh)(34)\n";
		push @output, "		dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(35)\n";
		push @output, "		; Need this for height fog if it's enabled and for height clipping																								; LINEINFO(VertexLitGeneric_inc.vsh)(37)\n";
		push @output, "		dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(38)\n";
	}																								
	else																								
	{																								
		&SkinPositionAndNormal( $g_numBones, $worldPos, $worldNormal );																								
		push @output, "		;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(44)\n";
		push @output, "		; Transform the position from world to view space																								; LINEINFO(VertexLitGeneric_inc.vsh)(45)\n";
		push @output, "		;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(46)\n";
		push @output, "		dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_inc.vsh)(47)\n";
		push @output, "		dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_inc.vsh)(48)\n";
		push @output, "		dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_inc.vsh)(49)\n";
		push @output, "		dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_inc.vsh)(50)\n";
	}																								
	push @output, "	mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_inc.vsh)(53)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(55)\n";
	push @output, "	; Fog																								; LINEINFO(VertexLitGeneric_inc.vsh)(56)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(57)\n";
	&CalcFog( $worldPos, $projPos );																								
	&FreeRegister( \$projPos, "\$projPos" );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(61)\n";
	push @output, "	; Lighting																								; LINEINFO(VertexLitGeneric_inc.vsh)(62)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(63)\n";
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(72)\n";
	push @output, "	; Texture coordinates																								; LINEINFO(VertexLitGeneric_inc.vsh)(73)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(74)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, c90		; FIXME																								; LINEINFO(VertexLitGeneric_inc.vsh)(76)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, c91		; FIXME																								; LINEINFO(VertexLitGeneric_inc.vsh)(77)\n";
	if( $envmap )																								
	{																								
		...
		{																								
			...
			push @output, "			; transform reflection vector into view space																								; LINEINFO(VertexLitGeneric_inc.vsh)(86)\n";
			push @output, "			dp3 oT1.x, $reflectionVector, $cViewModel0																								; LINEINFO(VertexLitGeneric_inc.vsh)(87)\n";
			push @output, "			dp3 oT1.y, $reflectionVector, $cViewModel1																								; LINEINFO(VertexLitGeneric_inc.vsh)(88)\n";
			push @output, "			dp3 oT1.z, $reflectionVector, $cViewModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(89)\n";
		...
		push @output, "		; envmap mask																								; LINEINFO(VertexLitGeneric_inc.vsh)(106)\n";
		push @output, "		dp4 oT2.x, $vTexCoord0, c92	; FIXME																								; LINEINFO(VertexLitGeneric_inc.vsh)(107)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, c93 ; FIXME																								; LINEINFO(VertexLitGeneric_inc.vsh)(108)\n";
		&FreeRegister( \$worldNormal, "\$worldNormal" );																								
	}																								
	else																								
	{																								
		push @output, "		; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(VertexLitGeneric_inc.vsh)(114)\n";
		push @output, "		mov oT1, $cZero																								; LINEINFO(VertexLitGeneric_inc.vsh)(115)\n";
		push @output, "		mov oT2, $cZero																								; LINEINFO(VertexLitGeneric_inc.vsh)(116)\n";
	}																								
	if( $detail )																								
	{																								
		push @output, "		dp4 oT3.x, $vTexCoord0, c94																								; LINEINFO(VertexLitGeneric_inc.vsh)(121)\n";
		push @output, "		dp4 oT3.y, $vTexCoord0, c95																								; LINEINFO(VertexLitGeneric_inc.vsh)(122)\n";
	}																								
	else																								
	{																								
