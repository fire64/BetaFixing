push @output, "vs.1.1																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(3)\n";
push @output, "; Shader specific constant:																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(4)\n";
 	 push @output, ";	 c95	 = [sOffset, tOffset, 0, 0]																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(5)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(6)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(10)\n";
push @output, "; Vertex blending																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(11)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(12)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(22)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(23)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(24)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(28)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(29)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(30)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(31)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(32)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(34)\n";
push @output, "; Fog																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(36)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(41)\n";
push @output, "; Lighting																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(42)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(43)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(45)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(46)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(47)\n";
push @output, "; to environment map space. 																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(48)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(49)\n";
push @output, "; svect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(51)\n";
push @output, "mov oT1.x, $worldTangentS.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(52)\n";
push @output, "mov oT2.x, $worldTangentS.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(53)\n";
push @output, "mov oT3.x, $worldTangentS.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(54)\n";
&FreeRegister( \$worldTangentS, "\$worldTangentS" );																								
push @output, "; tvect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(57)\n";
push @output, "mov oT1.y, $worldTangentT.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(58)\n";
push @output, "mov oT2.y, $worldTangentT.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(59)\n";
push @output, "mov oT3.y, $worldTangentT.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(60)\n";
&FreeRegister( \$worldTangentT, "\$worldTangentT" );																								
push @output, "; normal																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(63)\n";
push @output, "mov oT1.z, $worldNormal.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(64)\n";
push @output, "mov oT2.z, $worldNormal.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(65)\n";
push @output, "mov oT3.z, $worldNormal.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(66)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(70)\n";
&AllocateRegister( \$eyeVector, "\$eyeVector" );																								
push @output, "sub $eyeVector.xyz, $cEyePos, $worldPos  																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(72)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; eye vector																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(76)\n";
push @output, "mov oT4.xyz, $eyeVector																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(77)\n";
&FreeRegister( \$eyeVector, "\$eyeVector" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(81)\n";
push @output, "; Texture coordinates																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(82)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(83)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c94																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(84)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c95																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.vsh)(85)\n";
