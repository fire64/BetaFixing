push @output, "vs.1.1																								; LINEINFO(alienscale_vs14.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(3)\n";
push @output, "; Shader specific constant:																								; LINEINFO(alienscale_vs14.vsh)(4)\n";
 	push @output, ";	c90-c91 albedo 1 offset																								; LINEINFO(alienscale_vs14.vsh)(5)\n";
 	push @output, ";	c92-c93 albedo 2 offset																								; LINEINFO(alienscale_vs14.vsh)(6)\n";
 	push @output, ";	c94-c95 normalmap offset																								; LINEINFO(alienscale_vs14.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(8)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(12)\n";
push @output, "; Vertex blending																								; LINEINFO(alienscale_vs14.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(14)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(24)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(alienscale_vs14.vsh)(25)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(26)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(alienscale_vs14.vsh)(30)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(alienscale_vs14.vsh)(31)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(alienscale_vs14.vsh)(32)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(alienscale_vs14.vsh)(33)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(alienscale_vs14.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(36)\n";
push @output, "; Fog																								; LINEINFO(alienscale_vs14.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(38)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(43)\n";
push @output, "; Lighting 																								; LINEINFO(alienscale_vs14.vsh)(44)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(45)\n";
&DoLighting( $g_staticLightType, $g_ambientLightType, $g_localLightType1, 																								
			 $g_localLightType2, $worldPos, $worldNormal );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(49)\n";
push @output, "; Effects!																								; LINEINFO(alienscale_vs14.vsh)(50)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(51)\n";
push @output, "; svect																								; LINEINFO(alienscale_vs14.vsh)(52)\n";
push @output, "mov oT3.x, $worldTangentS.x																								; LINEINFO(alienscale_vs14.vsh)(53)\n";
push @output, "mov oT4.x, $worldTangentS.y																								; LINEINFO(alienscale_vs14.vsh)(54)\n";
push @output, "mov oT5.x, $worldTangentS.z																								; LINEINFO(alienscale_vs14.vsh)(55)\n";
&FreeRegister( \$worldTangentS, "\$worldTangentS" );																								
push @output, "; tvect																								; LINEINFO(alienscale_vs14.vsh)(58)\n";
push @output, "mov oT3.y, $worldTangentT.x																								; LINEINFO(alienscale_vs14.vsh)(59)\n";
push @output, "mov oT4.y, $worldTangentT.y																								; LINEINFO(alienscale_vs14.vsh)(60)\n";
push @output, "mov oT5.y, $worldTangentT.z																								; LINEINFO(alienscale_vs14.vsh)(61)\n";
&FreeRegister( \$worldTangentT, "\$worldTangentT" );																								
push @output, "; normal																								; LINEINFO(alienscale_vs14.vsh)(64)\n";
push @output, "mov oT3.z, $worldNormal.x																								; LINEINFO(alienscale_vs14.vsh)(65)\n";
push @output, "mov oT4.z, $worldNormal.y																								; LINEINFO(alienscale_vs14.vsh)(66)\n";
push @output, "mov oT5.z, $worldNormal.z																								; LINEINFO(alienscale_vs14.vsh)(67)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(alienscale_vs14.vsh)(70)\n";
&AllocateRegister( \$eyeDir, "\$eyeDir" );																								
push @output, "sub $eyeDir, $cEyePos, $worldPos																								; LINEINFO(alienscale_vs14.vsh)(73)\n";
&Normalize( $eyeDir );																								
push @output, "mov oT2, $eyeDir;																								; LINEINFO(alienscale_vs14.vsh)(75)\n";
&FreeRegister( \$eyeDir, "\$eyeDir" );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(81)\n";
push @output, "; Texture coordinates																								; LINEINFO(alienscale_vs14.vsh)(82)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs14.vsh)(83)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90	; albedo 1																								; LINEINFO(alienscale_vs14.vsh)(84)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(alienscale_vs14.vsh)(85)\n";
push @output, "dp4 oT1.x, $vTexCoord0, c94 ; normalmap																								; LINEINFO(alienscale_vs14.vsh)(87)\n";
push @output, "dp4 oT1.y, $vTexCoord0, c95																								; LINEINFO(alienscale_vs14.vsh)(88)\n";
