push @output, "vs.1.1																								; LINEINFO(WorldVertexAlpha.vsh)(1)\n";
...
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WorldVertexAlpha.vsh)(9)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WorldVertexAlpha.vsh)(10)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WorldVertexAlpha.vsh)(11)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WorldVertexAlpha.vsh)(12)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexAlpha.vsh)(13)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; garymcthack																								; LINEINFO(WorldVertexAlpha.vsh)(17)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexAlpha.vsh)(18)\n";
&CalcFog( $worldPos, $projPos );																								
&DoHeightClip( $worldPos, "oT2" );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexAlpha.vsh)(27)\n";
push @output, "; Texture coordinates																								; LINEINFO(WorldVertexAlpha.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexAlpha.vsh)(29)\n";
push @output, "; base texcoords																								; LINEINFO(WorldVertexAlpha.vsh)(30)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(WorldVertexAlpha.vsh)(31)\n";
push @output, "; lightmap texcoords																								; LINEINFO(WorldVertexAlpha.vsh)(33)\n";
push @output, "mov oT1, $vTexCoord1																								; LINEINFO(WorldVertexAlpha.vsh)(34)\n";
