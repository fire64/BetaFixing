push @output, "vs.1.1																								; LINEINFO(shadow_vs14.vsh)(1)\n";
...
push @output, "dp4 $projPos.x, $vPos, $cViewProj0																								; LINEINFO(shadow_vs14.vsh)(7)\n";
push @output, "dp4 $projPos.y, $vPos, $cViewProj1																								; LINEINFO(shadow_vs14.vsh)(8)\n";
push @output, "dp4 $projPos.z, $vPos, $cViewProj2																								; LINEINFO(shadow_vs14.vsh)(9)\n";
push @output, "dp4 $projPos.w, $vPos, $cViewProj3																								; LINEINFO(shadow_vs14.vsh)(10)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(shadow_vs14.vsh)(11)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(13)\n";
push @output, "; Fog																								; LINEINFO(shadow_vs14.vsh)(14)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(15)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(shadow_vs14.vsh)(19)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(shadow_vs14.vsh)(20)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, "; Shadow color																								; LINEINFO(shadow_vs14.vsh)(27)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(shadow_vs14.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(30)\n";
push @output, "; Texture coordinates																								; LINEINFO(shadow_vs14.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(32)\n";
push @output, "dp4 r0.x, $vTexCoord0, c90																								; LINEINFO(shadow_vs14.vsh)(33)\n";
push @output, "dp4 r0.y, $vTexCoord0, c91																								; LINEINFO(shadow_vs14.vsh)(34)\n";
push @output, "; Jittered versions																								; LINEINFO(shadow_vs14.vsh)(36)\n";
push @output, "mov oT0, r0																								; LINEINFO(shadow_vs14.vsh)(37)\n";
push @output, "add oT1, r0, c92																								; LINEINFO(shadow_vs14.vsh)(38)\n";
push @output, "sub oT2, r0, c92																								; LINEINFO(shadow_vs14.vsh)(39)\n";
push @output, "add oT3, r0, c93																								; LINEINFO(shadow_vs14.vsh)(40)\n";
push @output, "sub oT4, r0, c93																								; LINEINFO(shadow_vs14.vsh)(41)\n";
