push @output, "vs.1.1																								; LINEINFO(ParticleSphere.vsh)(1)\n";
...
$cQuarter = "c91.x";																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(7)\n";
push @output, "; Constants specified by the app																								; LINEINFO(ParticleSphere.vsh)(8)\n";
     push @output, ";    c0      = (0, 1, 2, 0.5)																								; LINEINFO(ParticleSphere.vsh)(9)\n";
 	 push @output, ";	 c1		 = (1/2.2, 0, 0, 0)																								; LINEINFO(ParticleSphere.vsh)(10)\n";
     push @output, ";    2      = camera position *in world space*																								; LINEINFO(ParticleSphere.vsh)(11)\n";
     push @output, ";    c4-c7   = modelViewProj matrix	(transpose)																								; LINEINFO(ParticleSphere.vsh)(12)\n";
     push @output, ";    c8-c11  = ViewProj matrix (transpose)																								; LINEINFO(ParticleSphere.vsh)(13)\n";
     push @output, ";    c12-c15 = model->world matrix (transpose)																								; LINEINFO(ParticleSphere.vsh)(14)\n";
 	 push @output, ";	 c16	 = [fogStart, fogEnd, fogRange, undefined]																								; LINEINFO(ParticleSphere.vsh)(15)\n";
 	 push @output, ";	 c17-c20 = model->view matrix (transpose)																								; LINEINFO(ParticleSphere.vsh)(16)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(17)\n";
push @output, "; The ParticleSphere lighting equation is:																								; LINEINFO(ParticleSphere.vsh)(18)\n";
push @output, "; A + [N dot ||L - P||] * C * r / |L - P|^2																								; LINEINFO(ParticleSphere.vsh)(19)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(20)\n";
push @output, "; where:																								; LINEINFO(ParticleSphere.vsh)(21)\n";
push @output, "; A = ambient light color																								; LINEINFO(ParticleSphere.vsh)(22)\n";
push @output, "; N = particle normal (stored in the texture)																								; LINEINFO(ParticleSphere.vsh)(23)\n";
push @output, "; L = directional light position																								; LINEINFO(ParticleSphere.vsh)(24)\n";
push @output, "; P = point on surface																								; LINEINFO(ParticleSphere.vsh)(25)\n";
push @output, "; C = directional light color																								; LINEINFO(ParticleSphere.vsh)(26)\n";
push @output, "; r = directional light intensity																								; LINEINFO(ParticleSphere.vsh)(27)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(28)\n";
push @output, "; This shader just does the |L - P| part and the pixel shader does the rest.																								; LINEINFO(ParticleSphere.vsh)(29)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(30)\n";
push @output, "; Vertex components																								; LINEINFO(ParticleSphere.vsh)(31)\n";
    push @output, ";   $vPos		= Position																								; LINEINFO(ParticleSphere.vsh)(32)\n";
 	push @output, ";	$vSpecular		= Directional light color																								; LINEINFO(ParticleSphere.vsh)(33)\n";
 	push @output, ";	$vColor		= Ambient color (and alpha)																								; LINEINFO(ParticleSphere.vsh)(34)\n";
 	push @output, ";	$vTexCoord0		= Texture coordinates for normal map																								; LINEINFO(ParticleSphere.vsh)(35)\n";
 	push @output, ";	$vTexCoord0.z	= Index into the light list for light info																								; LINEINFO(ParticleSphere.vsh)(36)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(40)\n";
push @output, "; Constant registers																								; LINEINFO(ParticleSphere.vsh)(41)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(42)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(44)\n";
push @output, "; Vertex blending																								; LINEINFO(ParticleSphere.vsh)(45)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(46)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(ParticleSphere.vsh)(50)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(ParticleSphere.vsh)(51)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(ParticleSphere.vsh)(52)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(ParticleSphere.vsh)(53)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(ParticleSphere.vsh)(54)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(ParticleSphere.vsh)(56)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(58)\n";
push @output, "; Fog																								; LINEINFO(ParticleSphere.vsh)(59)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(60)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $g_fogType eq "heightfog" )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(ParticleSphere.vsh)(65)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(ParticleSphere.vsh)(66)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(73)\n";
push @output, "; Setup to index our directional light.																								; LINEINFO(ParticleSphere.vsh)(74)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(75)\n";
push @output, "mov		a0.x, $vTexCoord0.z																								; LINEINFO(ParticleSphere.vsh)(76)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(79)\n";
push @output, "; Copy texcoords for the normal map texture																								; LINEINFO(ParticleSphere.vsh)(80)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(81)\n";
push @output, "mov		oT0, $vTexCoord0																								; LINEINFO(ParticleSphere.vsh)(83)\n";
push @output, "mov		oD1.xyz, $vColor																								; LINEINFO(ParticleSphere.vsh)(84)\n";
push @output, "; FIXME : the rest of this needs to use AllocateRegister																								; LINEINFO(ParticleSphere.vsh)(86)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(88)\n";
push @output, "; Generate a tangent space and rotate L.																								; LINEINFO(ParticleSphere.vsh)(89)\n";
push @output, "; This can be thought of as rotating the normal map to face the viewer.																								; LINEINFO(ParticleSphere.vsh)(90)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(91)\n";
push @output, "; This is useful when a particle is way off to the side of the screen.																								; LINEINFO(ParticleSphere.vsh)(92)\n";
push @output, "; You should be looking at the half-sphere with a normal pointing from the																								; LINEINFO(ParticleSphere.vsh)(93)\n";
push @output, "; particle to the viewer. Instead, you're looking at the half-sphere with																								; LINEINFO(ParticleSphere.vsh)(94)\n";
push @output, "; a normal along Z. This tangent space builder code fixes the problem.																								; LINEINFO(ParticleSphere.vsh)(95)\n";
 																								push @output, ";																								; LINEINFO(ParticleSphere.vsh)(96)\n";
push @output, "; Note that since the model and view matrices are identity, the coordinate																								; LINEINFO(ParticleSphere.vsh)(97)\n";
push @output, "; system has X=right, Y=up, and Z=behind you  (negative Z goes into the screen).																								; LINEINFO(ParticleSphere.vsh)(98)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(99)\n";
								push @output, "								; r5 (forward) = normalized P																								; LINEINFO(ParticleSphere.vsh)(100)\n";
push @output, "dp3		r1, $vPos, $vPos																								; LINEINFO(ParticleSphere.vsh)(101)\n";
push @output, "rsq		r5, r1																								; LINEINFO(ParticleSphere.vsh)(102)\n";
push @output, "mul		r5, r5, $vPos																								; LINEINFO(ParticleSphere.vsh)(103)\n";
push @output, "mov		r5.z, -r5.z				; This basis wants Z positive going into the screen																								; LINEINFO(ParticleSphere.vsh)(104)\n";
								push @output, "								; so flip it here.																								; LINEINFO(ParticleSphere.vsh)(105)\n";
								push @output, "								; r1 (up) = r5 x c24																								; LINEINFO(ParticleSphere.vsh)(107)\n";
push @output, "mul		r1, r5.xzyw, c90		; (This effectively does a cross product with [1,0,0,0]																								; LINEINFO(ParticleSphere.vsh)(108)\n";
								push @output, "								; You wind up with [0, r5.z, -r5.y, 1]																								; LINEINFO(ParticleSphere.vsh)(109)\n";
push @output, "dp3		r2, r1, r1																								; LINEINFO(ParticleSphere.vsh)(110)\n";
push @output, "rsq		r2, r2																								; LINEINFO(ParticleSphere.vsh)(111)\n";
push @output, "mul		r1, r1, r2																								; LINEINFO(ParticleSphere.vsh)(112)\n";
								push @output, "								; r2 (right) = r1 x r5																								; LINEINFO(ParticleSphere.vsh)(114)\n";
push @output, "mul		r2,  r1.yzxw, r5.zxyw																									; LINEINFO(ParticleSphere.vsh)(115)\n";
push @output, "mad		r2, -r1.zxyw, r5.yzxw, r2																								; LINEINFO(ParticleSphere.vsh)(116)\n";
push @output, "sub		r3, c[45 + a0.x], $vPos    ; r3 = L - P																								; LINEINFO(ParticleSphere.vsh)(118)\n";
push @output, "; transposed matrix mul																								; LINEINFO(ParticleSphere.vsh)(120)\n";
push @output, "mul		r0, r2, r3.xxxx			;   x * right																								; LINEINFO(ParticleSphere.vsh)(121)\n";
push @output, "mad		r0, r1, r3.yyyy, r0		; + y * up																								; LINEINFO(ParticleSphere.vsh)(122)\n";
push @output, "mad		r0, r5, r3.zzzz, r0		; + z * forward																								; LINEINFO(ParticleSphere.vsh)(123)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(126)\n";
push @output, "; Put ||L - P|| into t1																								; LINEINFO(ParticleSphere.vsh)(127)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(128)\n";
push @output, "dp3		r2, r0, r0			; r2 = Length(L - P)^2																								; LINEINFO(ParticleSphere.vsh)(129)\n";
push @output, "rsq		r3, r2				; r3 = 1 / Length(L - P)																								; LINEINFO(ParticleSphere.vsh)(130)\n";
push @output, "mul		r8, r0, r3			; r8 = Normalize(L - P)																								; LINEINFO(ParticleSphere.vsh)(131)\n";
push @output, "mul		r9, r8, $cQuarter		; r9 = Normalize(L - P) * 0.25																								; LINEINFO(ParticleSphere.vsh)(132)\n";
push @output, "add		oT1, r9, c0.w		; oT1 = Normalize(L - P) * 0.25 + 0.5																								; LINEINFO(ParticleSphere.vsh)(133)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(136)\n";
push @output, "; Setup the diffuse light color (C * r / ||L - P||^2)																								; LINEINFO(ParticleSphere.vsh)(137)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ParticleSphere.vsh)(138)\n";
push @output, "mul		r8, c[46 + a0.x], $vSpecular	; r8 = C * r																								; LINEINFO(ParticleSphere.vsh)(140)\n";
push @output, "rcp		r7, r2					; r7 = 1 / Length(L - P)^2																								; LINEINFO(ParticleSphere.vsh)(141)\n";
push @output, "; rescale the color if necessary																								; LINEINFO(ParticleSphere.vsh)(143)\n";
push @output, "mul		r8,  r8, r7				; r8 = C * r / Length(L - P)^2																								; LINEINFO(ParticleSphere.vsh)(144)\n";
push @output, "; We're doing both parts of an if statement here, with each part scaled by 0 or 1.																								; LINEINFO(ParticleSphere.vsh)(146)\n";
push @output, "mul		r9,  r7, c[46 + a0.x]	; r9 = r / Length(L - P)^2																								; LINEINFO(ParticleSphere.vsh)(147)\n";
push @output, "; If the light intensity scales the color > 1																								; LINEINFO(ParticleSphere.vsh)(149)\n";
	push @output, "	sge		r10, r9.xxxx, $cOne	; r10.x = 1 if the color's max component > 1																								; LINEINFO(ParticleSphere.vsh)(150)\n";
	push @output, "	rcp		r6,  r9.xxxx																											; LINEINFO(ParticleSphere.vsh)(151)\n";
	push @output, "	mul		r6,  r6, r10.xxxx		; r6 = 1 / max_component or [0,0,0,0] if max_component < 1																								; LINEINFO(ParticleSphere.vsh)(152)\n";
	push @output, "	mul		r2,  r8, r6				; rescaled color (all zeros if no component was > 1)																								; LINEINFO(ParticleSphere.vsh)(153)\n";
push @output, "; else																								; LINEINFO(ParticleSphere.vsh)(154)\n";
	push @output, "	slt		r11, r9.xxxx, $cOne	; r11.x = 1 if the color's max component < 1																								; LINEINFO(ParticleSphere.vsh)(155)\n";
	push @output, "	mad		oD0.xyz, r8, r11, r2	; if it was rescaled, then r8*r11 = 0																								; LINEINFO(ParticleSphere.vsh)(156)\n";
									push @output, "									; if not, then r8*r11 = the original color																								; LINEINFO(ParticleSphere.vsh)(157)\n";
push @output, "mov		oD0.a, $vColor.a				; Pass in vertex alpha so the pixel shader can use it.																								; LINEINFO(ParticleSphere.vsh)(159)\n";
