push @output, "vs.1.1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(3)\n";
push @output, "; Shader specific constant:																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(4)\n";
 	 push @output, ";	 c95	 = [sOffset, tOffset, 0, 0]																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(5)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(6)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(10)\n";
push @output, "; Vertex blending																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(11)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(12)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Transform position from object to world																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(16)\n";
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(17)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(18)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(19)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(23)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(24)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(25)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(26)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(27)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(29)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(31)\n";
push @output, "; Fog																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(32)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(33)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(38)\n";
push @output, "; Lighting																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(39)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(40)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(42)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(43)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(44)\n";
push @output, "; to environment map space. 																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(45)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(46)\n";
push @output, "dp3 oT1.x, $vTangentS, $cModel0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(48)\n";
push @output, "dp3 oT2.x, $vTangentS, $cModel1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(49)\n";
push @output, "dp3 oT3.x, $vTangentS, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(50)\n";
push @output, "dp3 oT1.y, $vTangentT, $cModel0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(52)\n";
push @output, "dp3 oT2.y, $vTangentT, $cModel1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(53)\n";
push @output, "dp3 oT3.y, $vTangentT, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(54)\n";
push @output, "dp3 oT1.z, $vNormal, $cModel0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(56)\n";
push @output, "dp3 oT2.z, $vNormal, $cModel1																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(57)\n";
push @output, "dp3 oT3.z, $vNormal, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(58)\n";
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(60)\n";
&AllocateRegister( \$worldEyeVect, "\$worldEyeVect" );																								
push @output, "sub $worldEyeVect.xyz, $cEyePos, $worldPos																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(62)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Move it into the w component of the texture coords, as the wacky																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(65)\n";
push @output, "; pixel shader wants it there.																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(66)\n";
push @output, "mov oT1.w, $worldEyeVect.x																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(67)\n";
push @output, "mov oT2.w, $worldEyeVect.y																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(68)\n";
push @output, "mov oT3.w, $worldEyeVect.z																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(69)\n";
local( $tangentEyeVect ); &AllocateRegister( \$tangentEyeVect, "\$tangentEyeVect" );
push @output, "; transform the eye vector to tangent space																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(73)\n";
push @output, "dp3 $tangentEyeVect.x, $worldEyeVect, $vTangentS																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(74)\n";
push @output, "dp3 $tangentEyeVect.y, $worldEyeVect, $vTangentT																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(75)\n";
push @output, "dp3 $tangentEyeVect.z, $worldEyeVect, $vNormal																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(76)\n";
&FreeRegister( \$worldEyeVect, "\$worldEyeVect" );																								
&Normalize( $tangentEyeVect );																								
push @output, "; stick the tangent space eye vector into oD0																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(82)\n";
push @output, "mad oD0.xyz, $tangentEyeVect, $cHalf, $cHalf																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(83)\n";
&FreeRegister( \$tangentEyeVect, "\$tangentEyeVect" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(87)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(88)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(89)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(90)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(LightmappedGeneric_BumpmappedEnvmap.vsh)(91)\n";
