push @output, "vs.1.1																								; LINEINFO(LightingOnly.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(5)\n";
push @output, "; Vertex blending 																								; LINEINFO(LightingOnly.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(7)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(12)\n";
push @output, "; Transform the position from model to proj																								; LINEINFO(LightingOnly.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(14)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(LightingOnly.vsh)(18)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(LightingOnly.vsh)(19)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(LightingOnly.vsh)(20)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(LightingOnly.vsh)(21)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightingOnly.vsh)(22)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(28)\n";
push @output, "; Lighting																								; LINEINFO(LightingOnly.vsh)(29)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(30)\n";
