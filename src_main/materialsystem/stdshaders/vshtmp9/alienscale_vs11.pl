push @output, "vs.1.1																								; LINEINFO(alienscale_vs11.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(3)\n";
push @output, "; Shader specific constant:																								; LINEINFO(alienscale_vs11.vsh)(4)\n";
    push @output, ";   c19 last row of world->camera transform																								; LINEINFO(alienscale_vs11.vsh)(5)\n";
 	push @output, ";	c90-c91 albedo 1 offset																								; LINEINFO(alienscale_vs11.vsh)(6)\n";
 	push @output, ";	c92-c93 albedo 2 offset																								; LINEINFO(alienscale_vs11.vsh)(7)\n";
 	push @output, ";	c94-c95 normalmap offset																								; LINEINFO(alienscale_vs11.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(9)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(13)\n";
push @output, "; Vertex blending																								; LINEINFO(alienscale_vs11.vsh)(14)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(15)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(25)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(alienscale_vs11.vsh)(26)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(27)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(alienscale_vs11.vsh)(31)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(alienscale_vs11.vsh)(32)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(alienscale_vs11.vsh)(33)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(alienscale_vs11.vsh)(34)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(alienscale_vs11.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(37)\n";
push @output, "; Fog																								; LINEINFO(alienscale_vs11.vsh)(38)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(39)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(44)\n";
push @output, "; Lighting 																								; LINEINFO(alienscale_vs11.vsh)(45)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(46)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(52)\n";
push @output, "; Effects!																								; LINEINFO(alienscale_vs11.vsh)(53)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(54)\n";
push @output, "; The pixel shader is going to need <sz, tz, nz> measured in *camera space*																								; LINEINFO(alienscale_vs11.vsh)(55)\n";
push @output, "; which isn't exactly correct, but good enough for ps1.1. We can do better																								; LINEINFO(alienscale_vs11.vsh)(56)\n";
push @output, "; in ps1.4. We've got s, t, and n in *world space*, so let's transform em.																								; LINEINFO(alienscale_vs11.vsh)(57)\n";
push @output, "; In order for this to work, we must have the last row of the world->camera																								; LINEINFO(alienscale_vs11.vsh)(58)\n";
push @output, "; transform in c19.																								; LINEINFO(alienscale_vs11.vsh)(59)\n";
push @output, "dp3 oT3.x, $worldTangentS, c19	; sz																								; LINEINFO(alienscale_vs11.vsh)(61)\n";
push @output, "dp3 oT3.y, $worldTangentT, c19	; tz																								; LINEINFO(alienscale_vs11.vsh)(62)\n";
push @output, "dp3 oT3.z, $worldNormal, c19	; nz																								; LINEINFO(alienscale_vs11.vsh)(63)\n";
&FreeRegister( \$worldTangentS, "\$worldTangentS" );																								
&FreeRegister( \$worldTangentT, "\$worldTangentT" );																								
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(70)\n";
push @output, "; Texture coordinates																								; LINEINFO(alienscale_vs11.vsh)(71)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(alienscale_vs11.vsh)(72)\n";
push @output, "dp4 oT0.x, $vTexCoord0, c90	; albedo 1																								; LINEINFO(alienscale_vs11.vsh)(73)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(alienscale_vs11.vsh)(74)\n";
push @output, "dp4 oT1.x, $vTexCoord0, c92	; albedo 2																								; LINEINFO(alienscale_vs11.vsh)(76)\n";
push @output, "dp4 oT1.y, $vTexCoord0, c93																								; LINEINFO(alienscale_vs11.vsh)(77)\n";
push @output, "dp4 oT2.x, $vTexCoord0, c94 ; normalmap																								; LINEINFO(alienscale_vs11.vsh)(79)\n";
push @output, "dp4 oT2.y, $vTexCoord0, c95																								; LINEINFO(alienscale_vs11.vsh)(80)\n";
